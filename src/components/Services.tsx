  ...
  const services = [
    {
      ...
      description:
        "Creating beautiful, user-centered designs that convert visitors into customers. Focused on modern UI/UX principles and responsive design.",
    ...
    },
    {
      ...
      features: ["React/Next.js", "TypeScript", "Modern CSS", "Web Performance"],
    },
    {
      id: 3,
      ...
      features: ["API Development", "Database Design", "Cloud Deployment", "DevOps"],
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {services.map((service) => (
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-white mb-4 font-mono">
                <span className="code-bracket">{"{ "}</span>
                <span className="code-string">&quot;{service.title}&quot;</span>
                <span className="code-bracket">{" }"}</span>
              </h3>
        ...
        <div className="mt-16">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {["React", "Next.js", "TypeScript", "Node.js", "Python", "MongoDB", "PostgreSQL", "AWS", "Docker"].map(
              (tech) => (
                <div
                  key={tech}
