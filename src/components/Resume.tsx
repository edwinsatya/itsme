...
const Resume = () => {
  const experiences = [
    ...
    },
    {
      ...
      description: "Developed responsive user interfaces and improved user experience across multiple web platforms.",
    },
    {
      period: "2016 - 2018",
  ...
  const skills = [
    ...
    { category: "Backend", items: ["Node.js", "Python", "PHP", "Express", "FastAPI"], level: 85 },
              ...
              {skills.map((skillGroup, index) => (
                <div key={index} className="bg-black border border-green-500/20 rounded-lg p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-green-400 font-mono text-sm">{skillGroup.level}%</span>
                  </div>
